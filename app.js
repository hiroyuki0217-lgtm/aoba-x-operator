const STORE_KEY = 'aoba-x-operator-v05';
const APP_RELEASE = '2026-08-16 14:02 JST';
...
const drafts = [
  {id:'01',category:'reach',pillar:'休日',title:'パン屋さんの前で振り返る',image:'./assets/aoba/weekend-camera-aware-v01.png',objective:'タイムライン停止率とプロフィール遷移',hypothesis:'歩いている途中に撮影者へ振り返る動きと柔らかな笑顔は、正面セルフィーより自然な初見停止を作りやすい',variable:'撮影方式を腕を伸ばすセルフィーから撮影者を意識した非セルフィーへ変更',text:'パン屋さんの前で、もう一回呼ばれた。\n振り向いた瞬間、ちゃんと撮れてた？🌿',alt:'休日の街歩き中、パン屋の前で撮影者に呼ばれて振り返り、柔らかく笑う23歳のあおば。淡いブルーの女性らしいミディ丈ワンピースと小さなブラウンのショルダーバッグを身につけています。AI生成の架空キャラクターです。'},
  {id:'02',category:'fan',pillar:'自宅',title:'部屋着で洗濯物と格闘中',image:'./assets/aoba/launch-09.jpg',objective:'返信率と再訪につながる親近感',hypothesis:'飾らない部屋着と家事の途中に見せる明るい表情は、作り込んだポーズより日常への親近感を作りやすい',variable:'自宅写真を腕を伸ばすセルフィーから撮影者へ反応する生活動作へ変更',text:'たたみ始めたら、白い服ばっかりでした。\n部屋着のまま、あと少しだけやります。',alt:'自宅でグレーのゆったりしたTシャツと濃い色の部屋着ショートパンツを着た23歳のあおば。床に座って洗濯物を持ち、撮影者へ明るく笑いかけています。室内では裸足です。AI生成の架空キャラクターです。'},
...
const defaultAssets = {
  ...
  work:'./assets/aoba/work-camera-aware-approved-v01.png',
  home:'./assets/aoba/launch-09.jpg',
  weekend:'./assets/aoba/weekend-camera-aware-v01.png'
};
...
function shell(title, subtitle, body) {
  return `<header class="top"><div><p class="eyebrow">AOBA X OPERATOR · v05</p><h1>${esc(title)}</h1><p class="sub">${esc(subtitle)}</p><p class="release">最終更新 ${esc(APP_RELEASE)}</p></div><span class="status-dot" title="公開は必ず本人承認"></span></header>${body}${nav()}`;
}

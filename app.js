...
const defaultState = () => ({ tab:'start', phase:0, done:{}, resetConfirm:false, drawerOpen:false, editingCharacter:false, visualVariant:0, dailyVariant:0, posts:[], characterAssets:{ face:'', work:'', home:'', weekend:'' }, characterProfile:{...canonicalProfile} });
